...
const options = {
  hostname: 'localhost',
  port: 3001,
  path: '/api/flow-analysis/analyze/18',
  method: 'POST'
}

console.log('正在重新分析文件ID 18...')
    ...
    try {
      ...
      if (result.code === 200 && result.data) {
        ...
        results.forEach((analysis, index) => {
          ...
          console.log(`   娱乐场所详情:`)
          if (analysis.restrictedConsumption?.entertainment) {
            analysis.restrictedConsumption.entertainment.forEach((item, i) => {
